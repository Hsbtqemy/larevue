...
urlpatterns = [
    ...
    path("<int:issue_id>/rapport/", views.IssueReportView.as_view(), name="report"),
    path("<int:issue_id>/sections/create/", views.SectionCreateView.as_view(), name="section_create"),
    path("<int:issue_id>/sections/reorder/", views.SectionReorderView.as_view(), name="section_reorder"),
    path("<int:issue_id>/sections/<int:section_id>/patch/", views.SectionPatchView.as_view(), name="section_patch"),
    path("<int:issue_id>/sections/<int:section_id>/delete/", views.SectionDeleteView.as_view(), name="section_delete"),
